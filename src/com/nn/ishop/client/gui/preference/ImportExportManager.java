...
public class ImportExportManager extends AbstractGUIManager implements
GUIActionListener, TableModelListener, ListSelectionListener{
	void init() {
		initTemplate(this, "preference/importExportPage.xml");
		render();
		bindEventHandlers();
		
	}
	public ImportExportManager(String locale){
			setLocale(locale);
			init();
	}
	@Override
