...
import com.nn.ishop.client.util.PlainTextXMLReader;
import com.nn.ishop.client.util.Util;


/**
 * User agent call back processing XML, CSS, Image
 * @author nghia
 *
 */
public class CXHTMLPanelManager extends NaiveUserAgent {
    /** index in history */ 
	private int index = -1;
    /** Kept <last URL> */
	...
	/* (non-Javadoc)
	 * @see org.xhtmlrenderer.swing.NaiveUserAgent#createImageResource(java.lang.String, java.awt.Image)
	 */
	...
	/* (non-Javadoc)
	 * @see org.xhtmlrenderer.swing.NaiveUserAgent#getXMLResource(java.lang.String)
	 */
...
//        }
	...
	public String resolveURI(String uri) {
		...
		if (uri.startsWith("connect:")) {
            ...
            ref = this.getClass().getResource(short_url);
            Uu.p("ref = " + ref);
        } else if (uri.startsWith("connectNav:")) {
            String short_url = uri.substring("connectNav:".length());
            if (!short_url.startsWith("/")) {
                short_url = "/" + short_url;
            }
            ref = this.getClass().getResource(short_url);
