...
public class CLabel extends JLabel {
	...
	private static final long serialVersionUID = 7298800624516117455L;
	private Object tag;
	...
	public CLabel(String text, Dimension d) {
		super(text);
		jbInit();
		setPreferredSize(d);
	}
	...
	public void setVertical(boolean clockwise) {
	...
	private void jbInit() {
		adjustLabelSize();// Adjust label size before adding text property change listener	
	}
	@Override
	...
	public synchronized void adjustLabelSize() {
		String text = getText();
		//Check if the Size is not wide enough
		Dimension dim = getSize();
		//Get font metrics from system default
		JLabel tempLabel = new JLabel();
		FontMetrics fm = tempLabel.getFontMetrics(tempLabel.getFont());
		int textWidth = fm.stringWidth(text);		
		if(textWidth>0 && textWidth > dim.width){
