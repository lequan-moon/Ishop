...
public class ScrollableBarUI extends ComponentUI 
  ...
  public void installUI(JComponent c) {
    ...
    // Create the Buttons
    int sbSize = 10;// ((Integer)(UIManager.get( "ScrollBar.width" ))).intValue();
    ...
    scroll = new JViewport() {
		private static final long serialVersionUID = 6016867822001912548L;

		protected LayoutManager createLayoutManager() {
          return new ViewportLayout() {
			private static final long serialVersionUID = 2079231923927574469L;
